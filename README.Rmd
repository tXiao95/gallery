...
[![Build Status](https://travis-ci.org/tXiao95/gallery.svg?branch=master)](https://travis-ci.org/tXiao95/gallery)
<!-- badges: end -->
...
You can install the released version of gallery from [GitHub](https://github.com/tXiao95/gallery) with:
